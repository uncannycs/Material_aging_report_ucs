...
tittle_style_color = xlwt.easyxf(
    'font: height 240, bold on; align: wrap on, vert centre, horiz center;' 'pattern: pattern solid, fore_colour 0x1B')
sub_tittle_style_color = xlwt.easyxf(
    'font: height 240, bold on; align: wrap on, vert centre, horiz center;' 'pattern: pattern solid, fore_colour 0x1A')
...
main_tittle_style = xlwt.easyxf(
    'font: height 240, name Arial, colour_index black, bold on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour ice_blue')

sub_main_tittle_style = xlwt.easyxf(
    'font: height 240, name Arial, colour_index black, bold on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour tan')

subTitle_style = xlwt.easyxf('font: height 200, bold on, italic on; align: wrap on, vert centre, horiz centre;')
subTitle_style_new = xlwt.easyxf(
    'font: height 200, name Arial, colour_index black, bold on, italic on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x1B')
subTitle_style_color = xlwt.easyxf(
    'font: height 200, bold on, italic on; align: wrap on, vert centre, horiz centre;' 'pattern: pattern solid, fore_colour 0x1A')
subTitle_style_color_left = xlwt.easyxf(
    'font: height 200, bold on, italic on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x1B')
subTitle_style_sub_color = xlwt.easyxf(
    'font: height 200, bold on, italic on; align: wrap on, vert centre, horiz centre;' 'pattern: pattern solid, fore_colour 0x1A')
subTitle_style_sub_color_left = xlwt.easyxf(
    'font: height 240, bold on, italic on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x1A')
subTitle_float_style_sub_color = xlwt.easyxf(
    'font: height 200, bold on, italic on; align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
subTitle_style_left = xlwt.easyxf('font: height 200, bold on, italic on; align: wrap on, vert centre, horiz left;')
subTitle_style_left_color = xlwt.easyxf(
    'font: height 200, bold on, italic on; align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour ice_blue')
subTitle_style_right_color = xlwt.easyxf(
    'font: height 200, bold on, italic on; align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour ice_blue')
subTitle_style_left1 = xlwt.easyxf('font: height 200, bold on, italic on; align: wrap on, vert top, horiz left;')

g_style = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x1B')

gn_style = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1B')
gn_style_nocolor = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;')

gtn_style = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1B')

gm_style = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1B')

style1_even = xlwt.easyxf(
    'font: bold off,height 200;' 'align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x1A')
...
normal_style_right_color = xlwt.easyxf(
    'font: bold off,height 200;' 'align: wrap on, vert bottom, horiz right;' 'pattern: pattern solid, fore_colour ice_blue')
normal_style_left_date = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert bottom, horiz left;')

style2_even = xlwt.easyxf(
    'font: bold off,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style2_odd = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert centre, horiz right;')

style3_even = xlwt.easyxf(
    'font: bold off,height 200;' 'align: wrap on, vert centre, horiz centre;' 'pattern: pattern solid, fore_colour 0x1A')
style3_odd = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert centre, horiz centre;')

style4_even = xlwt.easyxf(
    'font: bold off,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style4_odd = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert centre, horiz right;')

style5_even = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style5_odd = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;')

style6_even = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style6_odd = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;')

style7_even = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style7_odd = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;')

style8_even = xlwt.easyxf(
    'font: bold off,height 200,color red;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style8_odd = xlwt.easyxf('font: bold off,height 200,color red;' 'align: wrap on, vert centre, horiz right;')

style9_even = xlwt.easyxf(
    'font: bold off,height 200,color red;' 'align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x1A')
style9_odd = xlwt.easyxf('font: bold off,height 200,color red;' 'align: wrap on, vert centre, horiz left;')

style10_even = xlwt.easyxf(
    'font: bold off,height 200,color red;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style10_odd = xlwt.easyxf('font: bold off,height 200,color red;' 'align: wrap on, vert centre, horiz right;')

style11_even = xlwt.easyxf(
    'font: bold off,height 200,color red;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style11_odd = xlwt.easyxf('font: bold off,height 200,color red;' 'align: wrap on, vert centre, horiz right;')

style12_even = xlwt.easyxf(
    'font: bold off,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style12_odd = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert centre, horiz right;')

style12_title = xlwt.easyxf(
    'font: height 200, name Arial, colour_index white, bold on, italic on; align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x3C')

style13_even = xlwt.easyxf(
    'font: bold off,height 200;' 'align: wrap on, vert centre, horiz centre;' 'pattern: pattern solid, fore_colour 0x1A')
style13_odd = xlwt.easyxf('font: bold off,height 200;' 'align: wrap on, vert centre, horiz centre;')

style14_even = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz left;' 'pattern: pattern solid, fore_colour 0x1A')
style14_odd = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz left;')

style15_even = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;' 'pattern: pattern solid, fore_colour 0x1A')
style15_odd = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz right;')

style16_even = xlwt.easyxf(
    'font: bold on,height 200;' 'align: wrap on, vert centre, horiz centre;' 'pattern: pattern solid, fore_colour 0x1A')
style16_odd = xlwt.easyxf('font: bold on,height 200;' 'align: wrap on, vert centre, horiz centre;')
...
class ExcelStyles(object):
    ...
    def subTitle_new(self):
        subTitle_style_new.borders = borders
        return subTitle_style_new
    ...
    def subTitle_left_color(self):
        subTitle_style_left_color.borders = borders
        return subTitle_style_left_color

    def subTitle_right_color(self):
        subTitle_style_right_color.borders = borders
        return subTitle_style_right_color
    ...
    def normal_2num_right_color(self):
        normal_style_right_color.borders = borders
        normal_style_right_color.num_format_str = '########0.00'
        return normal_style_right_color

    def normal_num_right_color(self):
        normal_style_right_color.borders = borders
        normal_style_right_color.num_format_str = '########0.000'
        return normal_style_right_color

    def normal_num_right_color_3separator(self):
        normal_style_right_color.borders = borders
        normal_style_right_color.num_format_str = '###,###,##0.00'
        return normal_style_right_color
    ...
    def contentTextBoldCenter(self, dataRowNo, fontColor='', backColor=''):
        style16 = None
        if dataRowNo % 2 == 0:
            style16 = style16_even
        else:
            style16 = style16_odd
